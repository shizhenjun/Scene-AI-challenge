...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        #train net
        network = nets_factory.get_inception_vgg_network_fn(name=args.modelname, num_classes=len(train_set),
            weight_decay=args.weight_decay, dropout_keep_prob=args.dropout_keep, is_training=phase_train_placeholder, reuse=None)
        
        logits,_ = network(image_batch)
        
        #network = getattr(models,args.modelname)
        ...
        eval_network = nets_factory.get_inception_vgg_network_fn(name=args.modelname, num_classes=len(train_set),
            weight_decay=0.0, dropout_keep_prob=args.dropout_keep, is_training=False, reuse=True)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--modelname', type=str,
        help='Model Name.', default='inception_resnet_v2')
    ...
    parser.add_argument('--weight_decay', type=float,
        help='L2 weight regularization.', default=0.00004)  #dui yu vgg wangluo,wei 0.0005
