...
train_ann_file = '../../dataset/train/scene_train_annotations_20170904.json'
val_ann_file = '../../dataset/val/scene_validation_annotations_20170908.json'
test_dir = '../../dataset/testa/scene_test_a_images_20170922/'
clas_file = '../../dataset/testa/scene_classes.csv'
